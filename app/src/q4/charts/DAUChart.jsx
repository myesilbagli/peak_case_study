...
import { days, dauA, dauB } from '../../data/q4Metrics';
...
export function DAUChart() {
  ...
  const data = {
    labels: days,
    datasets: [
      { label: 'Variant A', data: dauA, borderColor: colors.navy, backgroundColor: colors.navyRgba, fill: true, tension: 0.2, pointRadius: 0 },
      { label: 'Variant B', data: dauB, borderColor: colors.red, backgroundColor: colors.redRgba, fill: true, tension: 0.2, pointRadius: 0 },
    ],
  };
  const options = {
    responsive: true,
